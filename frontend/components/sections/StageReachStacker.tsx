...
import {
  ...
  YardBackdrop,
  useStackerMotion,
} from "@/components/art/reach-stacker";
import { PinnedStage, StageLayer, useStage } from "@/components/motion/PinnedStage";
...
function StageScene() {
  ...
  return (
    /* The scene owns the lower band of the stage; type owns the top. */
