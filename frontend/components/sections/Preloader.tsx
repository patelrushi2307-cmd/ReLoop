...
export function Preloader() {
  ...
  return (
    ...
    >
      {open && (
        <motion.div
          className="fixed inset-0 z-[100] flex flex-col justify-between bg-[var(--black)] px-6 py-6 text-[var(--off-white)] md:px-10 md:py-8"
          initial={{ y: 0 }}
          exit={{ y: "-101%" }}
        ...
        >
          ...
          >
            <div>
              ...
              <div className="eyebrow mt-2 !text-[var(--grey-600)]">
                {brand.descriptor}
              </div>
            </div>
          ...
          >
            <WorldMapDots
              className="w-full max-w-[880px] text-[var(--off-white)]"
              reveal
              showHubs
              opacity={0.55}
            />
          ...
          >
              ...
              <Marquee axis="y" duration={14} className="h-full">
                <div>
                  {materials.map((c, i) => (
                    <div
                      key={`${c}-${i}`}
                      className="text-[13px] leading-[21px] text-[var(--grey-400)]"
                    >
                      {c}
                    </div>
                  ))}
            ...
            <div className="flex flex-1 items-end justify-end gap-6">
              <div className="hidden h-px flex-1 bg-[var(--grey-600)]/40 sm:block">
                <motion.div
                  className="h-full origin-left bg-[var(--off-white)]"
              ...
              <div className="flex items-end gap-1">
                ...
                <span className="eyebrow mb-2 !text-[var(--grey-600)]">%</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
